...
export default function PremiumCartScreen({ navigation }) {
  const { cart, addToCart, decreaseQty, removeFromCart, clearCart, getTotal } = useCart();
  ...
  const itemTotal = useMemo(() => getTotal(), [cart, getTotal]);
  // sample constants (move to context or fetch from server if needed)
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
          ...
          <View key={item.id} style={styles.itemCard}>
            <View style={styles.itemContent}>
              <View style={styles.itemImageContainer}>
                {/* item.image or item.img depending on your structure */}
                <Image
                  source={item.image || item.img || require('../assets/Dosa.jpg')}
              ...
              <View style={styles.itemDetails}>
                ...
                <TextInput
                  ...
                  value={item.note || ''}
                  onChangeText={(text) => {
                    // optional: add a setNote function in context if you want persistent notes
                  }}
                />
        ...
        {/* Coupon / Wallet / Summary (you can keep your existing UI; just use itemTotal etc.) */}
          ...
          <View style={styles.couponContent}>
            <View style={styles.couponLeft}>
              ...
              <View>
                ...
                <Text style={styles.couponCode}>Code: SAVE10</Text>
              </View>
            </View>
      ...
      <View style={styles.footer}>
        <View style={styles.footerContent}>
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('CheckoutScreen', { amount: amountToPay })}>
