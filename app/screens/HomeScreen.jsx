...
export default function HomeScreen() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      currentIndex = (currentIndex + 1) % banners.length;
      scrollRef.current?.scrollTo({ x: currentIndex * width * 0.9, animated: true });
    }, 4000);
    return () => clearInterval(interval);
  }, []);
                  ...
                  {banners.map((banner) => (
                    <Box
                      ...
                      <HStack alignItems='center'>
                        {/* Text + Subtitle + Icon below */}
                        <VStack flex={1} mr={3}>
                          <Text bold fontSize='xl' color='white' fontFamily='Poppins'>
                            {banner.title}
                          </Text>
                          <Text fontSize='sm' color='white' mt={2} fontFamily='OpenSans'>
                            {banner.subtitle}
                          </Text>

                          {/* Icon below subtitle */}
                          <Icon as={Ionicons} name={banner.icon} size='md' color='white' mt={3} />
                        </VStack>
                        ...
                        {/* Image */}
                        <Box width={120} height={120} rounded='full' overflow='hidden'>
                          <Image
                            source={banner.image}
                            alt='Banner Image'
                            resizeMode='cover'
